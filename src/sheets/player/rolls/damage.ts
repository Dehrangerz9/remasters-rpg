...
export const createDamageControls = async (sheet: any, baseDamage: number) => {
  const content = `
...
const applyDamageToTarget = async (sheet: any, baseDamage: number, multiplier: number, soakActive: boolean) => {
