...
export const openAttributeDialog = async (sheet) => {
    const dialog = await showDialog(game.i18n.localize("RMRPG.Dialogs.Attributes.Title"), `
...
export const openHpDialog = async (sheet) => {
    const dialog = await showDialog(game.i18n.localize("RMRPG.Dialogs.HP.Title"), `
      <form class="rmrpg-dialog-form">
        <div class="form-group">
...
export const openDefenseDialog = async (sheet) => {
    const current = Number(sheet.actor.system.defense?.value ?? 0);
    const dialog = await showDialog(game.i18n.localize("RMRPG.Dialogs.Defense.Title"), `
      <form class="rmrpg-dialog-form">
        <div class="form-group">
...
export const openDerivedDialog = async (sheet) => {
    ...
    const dialog = await showDialog(game.i18n.localize("RMRPG.Dialogs.Derived.Title"), `
      <form class="rmrpg-dialog-form">
...
export const openReikiDialog = async (sheet) => {
    ...
    const dialog = await showDialog(game.i18n.localize("RMRPG.Dialogs.Reiki.Title"), `
      <form class="rmrpg-dialog-form">
        <div class="form-group">
